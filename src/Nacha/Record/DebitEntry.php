...
class DebitEntry extends Entry {
	...
	public function setDFiAccountNumber($dFiAccountNumber) {
		$this->dFiAccountNumber = new StringUtil($dFiAccountNumber, 17);
		return $this;
	}
	public function setIndividualId($individualId) {
		$this->individualId = new StringUtil($individualId, 15);
		return $this;
	}
	public function setIdividualName($idividualName) {
		$this->idividualName = new StringUtil($idividualName, 22);
		return $this;
	}
