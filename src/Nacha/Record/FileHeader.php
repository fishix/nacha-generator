...
class FileHeader {
	...
	public function setFileCreationDate($fileCreationDate) {
		$this->fileCreationDate = new StringUtil($fileCreationDate, 6);
		return $this;
	}
	public function setFileCreationTime($fileCreationTime) {
		$this->fileCreationTime = new StringUtil($fileCreationTime, 4);
		return $this;
	}
	...
	public function setImmediateDestinationName($immediateDestinationName) {
		$this->immediateDestinationName = new StringUtil($immediateDestinationName, 23);
		return $this;
	}
	public function setImmediateOriginName($immediateOriginName) {
		$this->immediateOriginName = new StringUtil($immediateOriginName, 23);
		return $this;
	}
	public function setReferenceCode($referenceCode) {
		$this->referenceCode = new StringUtil($referenceCode, 8);
		return $this;
	}
