...
class BatchHeader {
	...
	public function setCompanyDiscretionaryData($companyDiscretionaryData) {
		$this->companyDiscretionaryData = new StringUtil($companyDiscretionaryData, 20);
		return $this;
	}
	public function setCompanyId($companyId) {
		$this->companyId = new StringUtil($companyId, 10);
		return $this;
	}
	...
	public function setCompanyDescriptiveDate($companyDescriptiveDate) {
		$this->companyDescriptiveDate = new StringUtil($companyDescriptiveDate, 6);
		return $this;
	}
	public function setEffectiveEntryDate($effectiveEntryDate) {
		$this->effectiveEntryDate = new StringUtil($effectiveEntryDate, 6);
		return $this;
	}
	public function setSettlementDate($settlementDate) {
		$this->settlementDate = new StringUtil($settlementDate, 3);
		return $this;
	}
	...
	public function setOriginatingDFiId($originatingDFiId) {
		$this->originatingDFiId = new StringUtil($originatingDFiId, 8);
		return $this;
	}
